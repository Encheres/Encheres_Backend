...
router.route('/neural-style-transfer-art-generation')
.get(async (req, res, next) => {

    const pyProg = spawn('python', ['./generative_models/neural-style-transfer-art-gen-script.py', 
                    req.query.contentHash, req.query.styleHash]);
